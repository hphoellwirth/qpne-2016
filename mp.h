...
/* convert  mp num/den back to rational in *result,
 * truncating down to first 9 digits to fit integer representation
 */
...
void trunc(mp Na,mp Da);          
	/* truncate Na Da to avoid integer overflow                    */
